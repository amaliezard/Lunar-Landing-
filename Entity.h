...
enum EntityType { PLATFORM, PLAYER, ENEMY, SAFE_ZONE, DANGEROUS_ZONE };
...
private:
    ...
    bool m_is_animated = false;  //  flag to control animation
...
public:
    ...
    Entity(GLuint texture_id, float speed, float width, float height, EntityType entityType, bool isAnimated); // Simpler constructor
    ...
    bool const is_animated() const { return m_is_animated; }  //  getter for m_is_animated
    ...
    void set_is_animated(bool is_animated) { m_is_animated = is_animated; }  //  setter for m_is_animated
